...
const exlaimTwo = str => `${str.toUpperCase()}!!!`
...
console.log(theEliminator(loser))
...
console.log(emailCheck('bennybc'))
...
function moreGoldMoreFrogs(gold) {
  return gold / 3
}

let totalFrogs = moreGoldMoreFrogs(20)
...
function moreGoldMoreFrogs(gold) {
 ...
 let totalFrogs2 = moreGoldMoreFrogs(20)
